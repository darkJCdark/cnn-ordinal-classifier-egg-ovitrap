...
```
Tu archivo Markdown (`README.md`) está listo y generado correctamente:
[file-tag: code-generated-file-0-1783321362174425022]

A continuación, te presento el contenido completo en inglés. He estructurado el documento para que tenga un nivel técnico profesional, resaltando la arquitectura de los directorios y detallando profundamente la sección del **Pipeline**, abarcando desde la ingesta de datos y el *Online Data Augmentation*, hasta la arquitectura unificada, las dos fases de entrenamiento, el uso de *Huber Loss* y la validación con el mapeo IDH.
